<div class="navbar-default sidebar" role="navigation">
    <div class="sidebar-nav navbar-collapse">
        <ul class="nav" id="side-menu">
            ...
            <li>
                <a href="#"><i class="fa fa-bar-chart-o fa-fw"></i> Team Info<span class="fa arrow"></span></a>
                <ul class="nav nav-second-level">
                    <li>
                        <a href="{{ route('add-team') }}">Add Team</a>
                    </li>
                    <li>
                        <a href="{{ route('manage-team') }}">Manage Team </a>
                    </li>
                </ul>
                <!-- /.nav-second-level -->
            </li>
            ...
            <li>
                <a href="#"><i class="fa fa-bar-chart-o fa-fw"></i> Service Info<span class="fa arrow"></span></a>
                <ul class="nav nav-second-level">
                    <li>
            ...
            <li>
                <a href="#"><i class="fa fa-bar-chart-o fa-fw"></i> Welcome Info<span class="fa arrow"></span></a>
                <ul class="nav nav-second-level">
                    <li>
                        <a href="{{ route('add-welcome') }}">Add Welcome</a>
                    </li>
                    <li>
                        <a href="{{ route('manage-welcome') }}">Manage Welcome </a>
                    </li>
                </ul>
                <!-- /.nav-second-level -->
            </li>
