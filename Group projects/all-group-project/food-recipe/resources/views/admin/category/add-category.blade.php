                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            ...
                            {{Form::open(['route'=>'new-category', 'method'=> 'POST', 'class'=>'form-horizontal'])}}
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input type="text" id="category_name" name="category_name" placeholder="Category Name" required="required" class="form-control col-md-7 col-xs-12">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="category_description">Category Description</label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <textarea class="form-control" name="category_description" placeholder="Category Description"  id="category_description"></textarea>
                                    </div>
                                </div>
                            <div class="form-group">
                            ...
                            <label><input type="radio" class="flat" name="publication_status" value="1"> Published</label>
