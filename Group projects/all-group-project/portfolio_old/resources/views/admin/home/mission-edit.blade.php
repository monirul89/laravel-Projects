                    ...
                    <form action="" method="POST" class="form-horizontal">
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group col-md-8">
                                <input type="text" value="{{$addcontent->mission_title}}" name="mission_title" placeholder="Mission Title" class="form-control" />
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="" class="control-label col-md-4">Mission Content</label>
                            <div class="form-group col-md-8">
                                <textarea name="mission_content" class="form-control" id="editor">{{$addcontent->mission_content}}</textarea>
                            </div>
                        </div>
                        <div class="form-group">
