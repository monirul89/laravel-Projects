...
<head>
    ...
    <link href="{{asset('/')}}admin-panel/css/datepicker3.css" rel="stylesheet">
    <link href="{{asset('/')}}admin-panel/css/styles.css" rel="stylesheet">

    <!--Custom Font-->
    <link href="https://fonts.googleapis.com/css?family=Montserrat:300,300i,400,400i,500,500i,600,600i,700,700i" rel="stylesheet">
    <!--[if lt IE 9]>
    <script src="{{asset('/')}}admin-panel/js/html5shiv.js"></script>
    <script src="{{asset('/')}}admin-panel/js/respond.min.js"></script>
    <![endif]-->
</head>
<body>
