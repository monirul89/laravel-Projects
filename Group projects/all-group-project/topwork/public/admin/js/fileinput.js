...
(function (factory) {
    ...
    defaultFileActionSettings = {
        ...
        zoomIcon: '<i class="fa fa-stumbleupon-circle"></i>',
        zoomClass: 'btn btn-xs btn-default',
        zoomTitle: 'View Details',
        dragIcon: '<i class="fa fa-cog"></i>',
        dragClass: 'text-info',
        ...
        indicatorLoading: '<i class="fa fa-thumbs-up text-muted"></i>',
    ...
    $.fn.fileinput.defaults = {
        ...
        previewZoomButtonIcons: {
            ...
            toggleheader: '<i class="fa fa-retweet"></i>',
        ...
        cancelIcon: '<i class="fa fa-genderless"></i>',
