        ...
        <div class="eleven columns">
            <div class="padding-right">
                ...
                <div class="post-container">
                    <div class="post-img"><a href="blog-single-post.html"><img src="{{asset('/')}}front/images/blog-post-01.jpg" alt=""></a><div class="hover-icon"></div></div>
                ...
                <!-- Post -->
                <div class="post-container">
                    <div class="post-img"><a href="blog-single-post.html"><img src="{{asset('/')}}front/images/blog-post-02.jpg" alt=""></a><div class="hover-icon"></div></div>
                    <div class="post-content">
                ...
                <!-- Post -->
                <div class="post-container">
                    <div class="post-img"><a href="blog-single-post.html"><img src="{{asset('/')}}front/images/blog-post-03.jpg" alt=""></a><div class="hover-icon"></div></div>
                    <div class="post-content">
                        ...
                        <ul class="widget-tabs">
                            ...
                            <li>
                                <div class="widget-thumb">
                                    <a href="blog-single-post.html"><img src="{{asset('/')}}front/images/blog-widget-01.png" alt="" /></a>
                                </div>
                            ...
                            <li>
                                <div class="widget-thumb">
                                    <a href="blog-single-post.html"><img src="{{asset('/')}}front/images/blog-widget-02.png" alt="" /></a>
                                </div>
                            ...
                            <li>
                                <div class="widget-thumb">
                                    <a href="blog-single-post.html"><img src="{{asset('/')}}front/images/blog-widget-03.png" alt="" /></a>
                                </div>
