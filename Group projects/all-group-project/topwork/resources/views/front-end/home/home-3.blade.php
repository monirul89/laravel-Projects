...
<div id="wrapper">
    ...
    <!-- Banner
    ================================================== -->
    <div id="banner" class="with-transparent-header parallax background" style="background-image: url(front/images/banner-home-02.jpg)" data-img-width="2000" data-img-height="1330" data-diff="300">
        <div class="container">
            <div class="sixteen columns">
    ...
    <div class="container">
        ...
        <div class="one-third column">
            ...
            <div class="recent-post">
                <div class="recent-post-img"><a href="blog-single-post.html"><img src="{{asset('/')}}front/images/recent-post-01.jpg" alt=""></a><div class="hover-icon"></div></div>
        ...
        <div class="one-third column">
            ...
            <!-- Post #2 -->
            <div class="recent-post">
                <div class="recent-post-img"><a href="blog-single-post.html"><img src="{{asset('/')}}front/images/recent-post-02.jpg" alt=""></a><div class="hover-icon"></div></div>
        ...
        <div class="one-third column">
            ...
            <!-- Post #3 -->
            <div class="recent-post">
                <div class="recent-post-img"><a href="blog-single-post.html"><img src="{{asset('/')}}front/images/recent-post-03.jpg" alt=""></a><div class="hover-icon"></div></div>
