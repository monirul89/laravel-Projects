                    ...
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form">
                                ...
                                {{Form::open(['route'=>'save-profile', 'method'=>'POST','id'=>'feedback_form', 'class'=>'form-validate form-horizontal', 'enctype'=>'multipart/form-data'])}}

                                <div class="form-group ">

                                    <label for="cname" class="control-label col-lg-2">Your Name <span class="required">*</span></label>
                                    <div class="col-lg-10">
                                        <input class="form-control" id="cname" placeholder="Your Name" name="candidate_name" minlength="5" type="text" required />
                                        <input class="form-control" name="candidate_id" type="text" value="{{ Auth::user()->id }}" />
                                    </div>
                                ...
                                <div class="form-group ">
                                    ...
                                    <div class="col-lg-10">
                                        <select name="selected_skill" id="" class="form-control from-control-login">
                                ...
                                <div class="form-group ">
                                    ...
                                    <div class="col-lg-10">
                                        <input class="form-control " id="cemail" type="hide" name="candidate_email" placeholder="Your Email" />
                                    </div>
                                </div>
                                <div class="form-group ">
                                    <label for="ccomment" class="control-label col-lg-2">Description</label>
                                    <div class="col-lg-10">
                                        <textarea class="form-control" id="editor" name="resume_description" required></textarea>
                                    </div>
                                </div>
                                ...
                                <div class="form-group ">
                                    ...
                                    <div class="col-lg-10">
                                        <input class="btn btn-file" name="candidate_image" type="file" required />
                                    </div>
                                </div>
