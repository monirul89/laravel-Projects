        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h4 class="text-center text-primary">Manage Slider Info</h4>
                </div>
                        ...
                        @foreach($sliders as $slider)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="{{ route('delete-slider', ['id'=>$slider->id]) }}" class="btn btn-danger btn-xs" onclick="return confirm('Do you want to Delete this slider??')" >
