        ...
        <div class="col-md-10 col-md-offset-1">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h4 class="text-center text-success">Edit Gallery Info</h4>
                </div>
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <textarea name="gallery_description" class="form-control">{{$gallery->gallery_description}}</textarea>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8 radio">
                            <label><input type="radio" checked name="publication_status" value="1" {{$gallery->publication_status == 1 ? 'checked': ' '}} />Published</label>
