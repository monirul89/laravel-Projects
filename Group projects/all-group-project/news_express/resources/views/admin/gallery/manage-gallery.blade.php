                        ...
                        @foreach($galleries as $gallery)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="{{ route('delete-gallery', ['id'=> $gallery->id]) }}" class="btn btn-danger btn-xs" onclick="return confirm('Do you want to Delete this Category??')" >
