<header class="main-header">
    ...
    <a href="{{ route('home') }}" class="logo">
        ...
        <span class="logo-mini"><b>A</b> news</span>
        <!-- logo for regular state and mobile devices -->
        <span class="logo-lg"><b>AMAR</b> news</span>
    </a>
                                ...
                                <li><!-- start message -->
                                    <a href="#">
                                        ...
                                        <h4>
                                            ...
                                            <small><i class="fa fa-clock-o"></i> 3 mins</small>
                                        </h4>
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="user-footer">
                            ...
                            <div class="pull-right">
                                <a href="#" onclick="document.getElementById('logoutForm').submit();" class="btn btn-default btn-flat">Sign out</a>
