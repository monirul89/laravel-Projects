        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h4 class="text-center text-success">Add Sub News Category</h4>
                </div>
                <div class="panel-body">
                    <h3 class="text-success" align="center">{{Session::get('message')}}</h3>
                    <br>
                    {{--<form action="{{route('new-sub-category')}}" method="post" class="form-horizontal">--}}
                    {{Form::open(['route'=>'new-sub-category','method'=>'POST','class'=>'form-horizontal'])}}
                        {{--{{csrf_field()}}--}}
                        <div class="form-group">
                            <label class="control-label col-md-4">Sub News Category Name</label>
                            <div class="col-md-8">
