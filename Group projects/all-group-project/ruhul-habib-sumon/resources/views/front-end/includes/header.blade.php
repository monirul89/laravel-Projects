...
<head>
    ...
    <link rel="stylesheet" href="http://netdna.bootstrapcdn.com/font-awesome/4.0.3/{{ asset('/') }}front/css/font-awesome.min.css" />
    <!-- Custom Theme files -->
    ...
    <div class="news-paper">
        <div class="header">
            <div class="header-left">
                <div class="logo">
                    <a href="{{ route('/') }}">
                        <h6>the</h6>
                        <h1>Amar <span>News</span></h1>
                    </a>
                </div>
            </div>
            <div class="social-icons">
                <li><a href="https://www.facebook.com/ruhulcse301/" target="_blank" title="facebook"><i class="twitter"></i></a></li>
                <li><a href="#" title="facebook"><i class="facebook"></i></a></li>
                ...
                <div class="fb-like" data-href="https://www.facebook.com/ruhulcse301/" target="_blank" data-layout="button_count" data-action="like" data-show-faces="true" data-share="false"></div>
                            ...
                            <div id="modal" class="popupContainer" style="display:none;">
                                ...
                                <section class="popupBody">
                                    ...
                                    <div class="social_login">
                                        <div class="">
                                            <a href="https://www.facebook.com/ruhulcse301/" target="_blank" class="social_box fb" title="facebook">
        ...
        <div class="menu-strip">
            <ul>
                ...
                <li><a href="{{ route('category-news') }}">{{ $category->category_name }}</a></li>
                @endforeach

                {{--<li><a href="{{ route('sports-news') }}">sports</a></li>--}}
